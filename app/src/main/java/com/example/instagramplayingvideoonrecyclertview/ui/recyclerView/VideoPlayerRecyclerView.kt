package com.example.instagramplayingvideoonrecyclertview.ui.recyclerView
...
class VideoPlayerRecyclerView : RecyclerView {
    ...
    private fun init(context: Context) {
        ...
        //use controller remove basic and default ui for exo player
        //like seek bar
        ...
        addOnScrollListener(object : OnScrollListener() {
            override fun onScrollStateChanged(
                ...
                if (newState == SCROLL_STATE_IDLE) {
                    ...
                    //direction 1 means scroll to down
                    //direction -1 means scroll to up
        ...
        //when scroll up or down view attach or detach to recycler view
    ...
    private fun removeVideoView(videoView: PlayerView?) {
        ...
        if (videoView!!.parent != null) {
            var parent: ViewGroup = videoView?.parent as ViewGroup
